                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action-btns">
                                            <!-- <a href="valid_reservation.php?id=<?= $res['id'] ?>" class="btn btn-sm btn-info">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action-btns">
                                            <!-- <a href="afiche_profil_commentaire.php?id=<?= $com['id'] ?>" class="btn btn-sm btn-info">
                                                <i class="fas fa-eye"></i>
                                            </a> -->
                                            <a href="admin.php?del=<?= $com['id'] ?>&type=comment" class="btn btn-sm btn-danger" onclick="return confirm('Supprimer ce commentaire?')">
                                                <i class="fas fa-trash"></i>
                                            </a>
                                            <?php //if(!empty($com['reponse_com'])): ?>
                                            <!-- <span class="badge bg-success" title="A une réponse"> -->
